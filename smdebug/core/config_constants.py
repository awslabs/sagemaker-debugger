...
SM_PROFILER_FILE_PATH_ENV_STR = "SM_PROFILER_FILE_PATH"  # File path to trace event file
...
DEFAULT_SAGEMAKER_PROFILER_PATH = "/opt/ml/input/config/profiler_config.json"
