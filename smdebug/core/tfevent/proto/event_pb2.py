...
from smdebug.core.tfevent.proto import (
    summary_pb2 as smdebug_dot_core_dot_tfevent_dot_proto_dot_summary__pb2,
)
...
_LOGMESSAGE_LEVEL = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="WARN", index=3, number=30, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
...
_SESSIONLOG_SESSIONSTATUS = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="STATUS_UNSPECIFIED", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="START", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STOP", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CHECKPOINT", index=3, number=3, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_EVENT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="wall_time",
            full_name="smdebug.Event.wall_time",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="file_version",
            full_name="smdebug.Event.file_version",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="graph_def",
            full_name="smdebug.Event.graph_def",
            index=3,
            number=4,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="summary",
            full_name="smdebug.Event.summary",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="log_message",
            full_name="smdebug.Event.log_message",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="session_log",
            full_name="smdebug.Event.session_log",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="smdebug.Event.tagged_run_metadata",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="meta_graph_def",
            full_name="smdebug.Event.meta_graph_def",
            index=8,
            number=9,
            type=12,
            cpp_type=9,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="what", full_name="smdebug.Event.what", index=0, containing_type=None, fields=[]
        )
    ],
    serialized_start=94,
    serialized_end=397,
...
_LOGMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="message",
            full_name="smdebug.LogMessage.message",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_SESSIONLOG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="status",
            full_name="smdebug.SessionLog.status",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="smdebug.SessionLog.checkpoint_path",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="msg",
            full_name="smdebug.SessionLog.msg",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_TAGGEDRUNMETADATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="tag",
            full_name="smdebug.TaggedRunMetadata.tag",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="run_metadata",
            full_name="smdebug.TaggedRunMetadata.run_metadata",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_EVENT.fields_by_name[
    "summary"
].message_type = smdebug_dot_core_dot_tfevent_dot_proto_dot_summary__pb2._SUMMARY
