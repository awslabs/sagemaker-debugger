...
from .collection import add_to_collection, CollectionKeys
...
class TornasoleOptimizer(tf.train.Optimizer):
    def __init__(self, optimizer, use_locking=False, name="Tornasole"):
        ...
        add_to_collection(CollectionKeys.OPTIMIZER_VARIABLES, optimizer.variables())

    def apply_gradients(self, grads_and_vars, global_step=None, name=None):
        add_to_collection(CollectionKeys.GRADIENTS, [g for (g, v) in grads_and_vars])
