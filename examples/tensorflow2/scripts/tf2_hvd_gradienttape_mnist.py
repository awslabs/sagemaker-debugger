...
def training_step(images, labels, first_batch):
    ...
    # Wrap GradientTape with smdebug hook
    ...
    acc = train_acc_metric(labels, probs)
    smd_hook.record_tensor_value(tensor_name="accuracy", tensor_value=acc)
...
if __name__ == "__main__":
    ...
    for batch, (images, labels) in enumerate(dataset.take(10000 // hvd.size())):
        smd_hook.save_scalar("step_number", batch + 1, sm_metric=False)
