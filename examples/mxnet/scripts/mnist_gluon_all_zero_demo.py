...
def parse_args():
    ...
    parser.add_argument('--batch-size', type=int, default=256,
                        help='Batch size')
    parser.add_argument('--tornasole_path', type=str, default='s3://tornasole-testing/all-zero-hook/trial-3',
...
def main():
    ...
    train_model(batch_size, net, train_data, valid_data,
                opt.learning_rate, hook, num_steps=opt.num_steps)
