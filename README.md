...
| [XGBoost](docs/xgboost.md) | 0.90-2, 1.0-1, 1.2-1 ([As a built-in algorithm](docs/xgboost.md#use-xgboost-as-a-built-in-algorithm))|
...
| [XGBoost](docs/xgboost.md) |  0.90-2, 1.0-1, 1.2-1 (As a framework)|
