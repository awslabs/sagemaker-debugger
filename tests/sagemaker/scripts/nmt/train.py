...
class Train(object):
  ...
  """
    ...
    """
        ...
        with tf.GradientTape() as tape:
            ...
            dec_input = tf.expand_dims(
                [self.targ_lang.word_index["<start>"]] * self.per_replica_batch_size, 1
            )
    ...
    """
        ...
        return (self.train_loss_metric.result().numpy(), self.test_loss_metric.result().numpy())
...
def main(
    ...
    train_obj = Train(
        epochs, enable_function, encoder, decoder, inp_lang, targ_lang, batch_size, batch_size
    )
    print("Training ...")
