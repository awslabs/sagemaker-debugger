...
def test_no_refresh_s3():
    help_test_no_refresh("s3://smdebug-testing/outputs/rules/ts_output/train/")
...
def test_refresh_with_range_s3():
    help_test_refresh_with_range("s3://smdebug-testing/outputs/rules/ts_output/train/")
...
def test_refresh_s3():
    help_test_refresh("s3://smdebug-testing/outputs/rules/ts_output/train/")
